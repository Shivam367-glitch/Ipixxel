  ...
  return (
    <Container className="">
        <Row className="d-flex flex-column gap-3">
            ...
            <h3 className="display-6 fw-medium">Our Clients</h3>
            </Col>
            <Col className="col-12">
              <p className="text-secondary fw-normal" >Providing tailored solutions and expert guidance to optimize IT infrastructure for our diverse clientele, ensuring seamless operations and technological excellence.</p>
            </Col>
